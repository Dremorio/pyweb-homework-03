...
if __name__ == '__main__':
    ...
    result_sync, time_sync = run_time(factorize_list, test_numbers)
    result_parallel, time_parallel = run_time(parallel_factorize_list, test_numbers)

    print("Синхронна версія:")
    print("Результат:", result_sync)
    print("Час виконання:", time_sync)

    print("\nПаралельна версія:")
    print("Результат:", result_parallel)
    print("Час виконання:", time_parallel)
